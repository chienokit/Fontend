...
export class ToastService {
  ...
  success(content: string, interpolateParams?: object, options?: NzNotificationDataOptions): void {
  ...
  error(content: string, interpolateParams?: object, options?: NzNotificationDataOptions): void {
  ...
  info(content: string, interpolateParams?: object, options?: NzNotificationDataOptions): void {
  ...
  warning(content: string, interpolateParams?: object, options?: NzNotificationDataOptions): void {
  ...
  blank(content: string, interpolateParams?: object, options?: NzNotificationDataOptions): void {
