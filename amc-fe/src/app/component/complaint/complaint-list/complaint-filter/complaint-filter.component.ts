...
import { COMPLAINT_RATING_ARR, COMPLAINT_STATUS_ARR, COMPLAINT_TYPE_ARR } from '@shared/constants/complaint.constant';
import { Building } from '@shared/models/building.model';
import { ComplaintSearchRequest, IComplaintSearchRequest } from '@shared/models/request/complaint-search-request.model';
...
export class ComplaintFilterComponent implements OnInit {
  ...
  initForm(searchRequest: IComplaintSearchRequest): void {
    this.form = this.fb.group({
      ...
      startCreatedAt: [this.searchRequest?.startCreatedAt ? new Date(this.searchRequest?.startCreatedAt) : null],
      endCreatedAt: [this.searchRequest?.endCreatedAt ? new Date(this.searchRequest?.endCreatedAt) : null],
