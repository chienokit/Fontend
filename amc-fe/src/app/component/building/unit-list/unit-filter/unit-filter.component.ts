...
import { LEASING_STATUS_LIST, UNIT_TYPE_LIST } from '@shared/constants/building.constants';
...
export class UnitFilterComponent implements OnInit {
  ...
  loadFloors(keyword?: string): void {
    ...
    this.buildingService.simpleSearchFloor(this.filterRequest?.buildingIds[0], {keyword, sortBy: 'floorNumber.asc'}).subscribe(
      (data) => {
